...
// NOTE: The device implementations (TP35ProProtocol, etc.) are defined in
// hardware/protocol.rs and re-exported via the DeviceProtocol trait.
// Device definition stays here in core/device/ for domain clarity.
// This will be refactored in Phase 5 to move protocol impls to core/device/protocol.rs.
use crate::hardware::protocol::TP35ProProtocol;
